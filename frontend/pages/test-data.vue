  ...
  <div class="space-y-6">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 flex items-center justify-between">
      ...
      <button :disabled="inferring"
        ...
        {{ inferring ? 'Running...' : 'Run YOLO Test' }}
      </button>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
      <h2 class="font-bold text-dark/60 uppercase tracking-wide text-sm mb-4">Test Images</h2>
    ...
    <!-- Test Results -->
    <div v-if="testResults.length" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
      <h2 class="font-bold text-dark/60 uppercase tracking-wide text-sm mb-4">Test Inference Results</h2>
      <div class="space-y-4">
