  ...
  <div class="space-y-6">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-dark/50">{{ cocoItems.length }} val images with COCO annotations</p>
      </div>
    </div>

    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 text-sm text-blue-700">
      Uses COCO ground truth annotations from train data split for YOLO26 validation.
    </div>
