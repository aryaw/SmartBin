> **Visualization Export:** All pipeline step images available at `waste_datasource/visualization/` (54 folders across 6 processes). Generated by `backend/app/scripts/generate_visualizations.py`.
